...
> Generated at: 2026-07-10T21:20:41.824992

## Conclusion

- Top5 exact evidence recall: 88.89%
- Top10 exact evidence recall: 100.00%
- Top5 page recall: 88.89%
...
- Cases: 9
- Company: 德合集團
- Coverage: customer concentration, supplier concentration, cash flow pressure, litigation, license qualification, loss, gross margin, debt ratio.

## Case Results

| ID | Risk type | Top5 exact | Top10 exact | Top5 page | Top10 page |
|---|---|---:|---:|---:|---:|
| `gold_001` | customer_concentration | False | True | False | True |
...
- `gold_001` customer_concentration: expected ['ev_2020_00368_德合集團_p10_txt002']
